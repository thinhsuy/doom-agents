/** Inline icon set — no external icon library, nothing loaded at runtime. */
...
export function Icon({ name, size = 19, color = 'currentColor', strokeWidth = 1.9, className }: Props) {
  return (
    <svg
      width={size}
      height={size}
